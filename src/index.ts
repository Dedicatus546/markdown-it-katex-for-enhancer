...
const math_inline: StateInlineRuleFn = (state, silent) => {
  let match: number, token: Token, res: IsValidDelimResult, pos: number;
...
const math_block: StateBlockRuleFn = (state, start, end, silent) => {
...
export const math: MarkdownItPlugin<[MathOptions]> = (md, options) => {
  // Default options
